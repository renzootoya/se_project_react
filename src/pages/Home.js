...
const Home = ({ currentUser, isLoggedIn, clothingItems, setClothingItems, onCardLike, onDeleteClothing }) => {
  ...
  if (loading) return <div className="home-container"><p className="loading">Loading...</p></div>;
